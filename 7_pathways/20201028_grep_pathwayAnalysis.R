...
heatplot(yy)
ggsave("~/projects/miscarriage/pathway/grep/20201028_grep_analysis/plot/grep_aggregate_heat.png")
...
#  entrezID=sample$ENTREZID
#  gene=entrezID
#  yy = enrichPathway(gene, organism = "human", pvalueCutoff = 0.05, pAdjustMethod = "BH", qvalueCutoff = 0.05, minGSSize = 10, maxGSSize = 500, readable = TRUE)
#  recap=head(as.data.frame(yy))
