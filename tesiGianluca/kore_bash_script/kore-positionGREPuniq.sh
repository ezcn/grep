...
cat /mpba0/vcolonna/gianluca/TESI/hgdp/positionGREP/positionGREP.${chr}.bed | sort | uniq -u  > /mpba0/vcolonna/gianluca/TESI/hgdp/positionGREP/positionGREPuniq.${chr}.bed
