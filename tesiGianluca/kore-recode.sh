...
~/bin/vcftools --gzvcf /mpba0/vcolonna/IMMA/samples/fb/vep/mergedByChr/merged.chr22.fb.vep.vcf.gz --positions /mpba0/vcolonna/gianluca/TESI/hgdp/positionALLuniqB.chr22.bed --recode --recode-INFO-all --out /mpba0/vcolonna/gianluca/TESI/hgdp/merged.chr22.B.fb.vep.vcf
