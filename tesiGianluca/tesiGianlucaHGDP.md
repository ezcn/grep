...
```
# 4) gzip file and use Python script [GREP](filtering/AFS-GREP_grepl.py) and [HGDP](filtering/AFS-HGDP_random_grepl.py) for obtain frequency of allele in VCF [kore-grepPy.sh](kore-grepPy.sh) and [kore-hgdpPy.sh](kore-hgdpPy.sh)
```
