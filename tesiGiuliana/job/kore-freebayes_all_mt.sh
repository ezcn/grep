...
~/bin/freebayes -f /mpbastudies3/IMMA/hg38p12/hg38.p12.fa -p 1 -r chrM -L /mpba0/vcolonna/giuliana/bam-list | ~/bin/bgzip > /mpbastudies3/IMMA/samples/fb/mitochondrial/ALLgrep.chrM.vcf.gz
