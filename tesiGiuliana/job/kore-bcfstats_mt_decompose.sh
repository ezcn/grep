...
~/bin/bcftools stats /mpbastudies3/IMMA/samples/fb/mitochondrial/normalized/decomposed/${id}.chrM.fb.norm.decompose.vcf.gz > /mpba0/vcolonna/IMMA/samples/fb/mitochondrial/VCFstats_mt/${id}.chrM.decompose.bcf-stats
