...
zcat /mpba0/vcolonna/IMMA/samples/fb/mitochondrial/ALLgrep.chrM.vcf.gz | ~/bin/vcffilter -f "QUAL > 20" > /mpba0/vcolonna/IMMA/samples/fb/mitochondrial/filtered/ALLgrep.chrM.fb.filt.vcf
