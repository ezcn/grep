...
~/bin/freebayes -f /mpbastudies3/IMMA/hg38/hg38.p12.fa -r ${chr} --gvcf -g 2000  /mpbastudies3/IMMA/samples/${idsample}.bam | bgzip > /mpbastudies3/IMMA/samples/vcf/${idsample}.vcf.gz
